...
const Input = ({onKeyUp, name, label, placeholder, onChange, id, value, error = false, horizontal = true, type="text", disabled = false, message = "", depend = null }) => {
    ...
    return (
        <React.Fragment>
            <div className={`input-form ` + inputClasses}>
                ...
                <input onKeyUp={onKeyUp} placeholder={''} onChange={onChange} value={value} disabled={disabled} data-depend={depend} name={name} id={id} type={type} className={inputClasses} />

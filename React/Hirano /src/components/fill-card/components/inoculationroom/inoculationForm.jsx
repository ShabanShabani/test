...
class InoculationForm extends Form {
    constructor(props) {
        super(props);
        this.state = {
            errors: {},
            ...
            <React.Fragment>
                <div className={`extra-form`}>
                    ...
                    <div className="materials">
                        ...
                        {/* <input value={history.nr_blocks_shelf} onChange={(e) => onChange(e, index)} type="number" placeholder={getLanguage().nrblocks_shelf} /> */}
...
export default InoculationForm;
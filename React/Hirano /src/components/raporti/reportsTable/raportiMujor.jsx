...
class RaportiMujor extends Component {
    ...
    constructor(props)
    {
        ...
        this.state = {
            ...
            columns: [
                ...
                { title: 'Numri i bllokave', field: 'nr_predicted_blocks' },
                { title: 'Numri i fares', field: 'inoculation_room.nr_seed' },
            ...
            <React.Fragment>
                <MaterialTable
                    ...
                    options={{
                        ...
                        exportFileName: `Raporti Mujor me daten ${month}.${year}`
                    }}
                />
            </React.Fragment>
        );
